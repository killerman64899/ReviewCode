...
public class StartupBust {
    ...
    void checkUserGuess(String userGuess) {
        ...
        for (Startup startupToCheck : startups) {
            ArrayList<String> locationsOfStartup = startupToCheck.getLocations();
            if (startupToCheck.getLifeState() == true) {
                if (locationsOfStartup.contains(userGuess)) {
                    result = "Hit";
                    locationsOfStartup.remove(locationsOfStartup.indexOf(userGuess));
                    if (locationsOfStartup.isEmpty()) {
                        result = "You sunk "+startupToCheck.getName()+"!";
                        startupToCheck.setLifeState(false);
                    }
                }
            }
